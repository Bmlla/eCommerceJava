...
<body>
    ...
    <table id="produtos">
        ...
        <c:forEach items="${Carrinho}" var="produto" varStatus="loop">
            <tr>
                ...
                <td class="tdRightAlign"><a class="button" onclick="baga(this);" href="${contextPath}/loja/Carrinho?action=Excluir&id=${loop.index}">Excluir</a></td>
            </tr>
        </c:forEach>
    </table>
</body>
